...
$btnExport = button_html('Export Report', 'outline', icon: 'download');
$btnAnnouncement = button_html('New Announcement', 'default', icon: 'megaphone');
$greeting = <<<HTML
  <div class="greeting">
    <div>
...
if ($reportsRows === '') {
    ...
    <div class="panel-foot"><a href="#" class="btn-link">View all ' . e($reportsPending['total']) . ' reports ' . chevron_right() . '</a></div>
    ' . $pagination;
}
  ...
  <div class="panel" id="case-density-panel">
    <div class="panel-head">
      ...
      <div class="map-tools">
        ...
        <a href="#" class="btn-link">Open full map ' . chevron_right() . '</a>
      </div>
    </div>
...
$activityTable = '
  <div class="panel">
    <div class="panel-head">
      ...
      <a href="#" class="btn-link">View all cases ' . chevron_right() . '</a>
    </div>
