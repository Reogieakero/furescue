  ...
  <div class="panel animal-panel">
    <div class="panel-head">
      ...
      <div class="panel-head-tools">
        <div id="animal-filter-tabs-wrap">${TabStrip({ id: "animal-filter-tabs", children: FilterTabs() })}</div>
      </div>
    </div>
...
export function syncDetailLayout() {
  const split = document.querySelector(".animal-split");
  if (split) split.classList.toggle("is-detail-open", Boolean(state.selectedId));
}
