...
function SelectItem({ value = "", label = "", selected = false } = {}) {
  return `
  <div role="option" aria-selected="${selected}" data-select-item data-value="${esc(value)}" class="${cn(
    ...
    <span data-select-item-label>${esc(label)}</span>
...
export function Select({
  ...
  return `
  <div id="${esc(id)}" data-select class="${cn("relative inline-block", className)}">
